        ...
        let result = stmt
            .query_map([], |row| {
                ...
                Ok(QuestTemplate {
                    ...
                    required_item_ids: [
                        row.get("required_item_id1").unwrap(),
                        row.get("required_item_id2").unwrap(),
                        row.get("required_item_id3").unwrap(),
                        row.get("required_item_id4").unwrap(),
                    ],
                    required_item_counts: [
                        row.get("required_item_count1").unwrap(),
                        row.get("required_item_count2").unwrap(),
                        row.get("required_item_count3").unwrap(),
                        row.get("required_item_count4").unwrap(),
                    ],
                    required_source_item_ids: [
                        row.get("required_source_item_id1").unwrap(),
                        row.get("required_source_item_id2").unwrap(),
                        row.get("required_source_item_id3").unwrap(),
                        row.get("required_source_item_id4").unwrap(),
                    ],
                    required_source_item_counts: [
                        row.get("required_source_item_count1").unwrap(),
                        row.get("required_source_item_count2").unwrap(),
                        row.get("required_source_item_count3").unwrap(),
                        row.get("required_source_item_count4").unwrap(),
                    ],
                    required_entity_ids: [
                        row.get("required_entity_id1").unwrap(),
                        row.get("required_entity_id2").unwrap(),
                        row.get("required_entity_id3").unwrap(),
                        row.get("required_entity_id4").unwrap(),
                    ],
                    required_entity_counts: [
                        row.get("required_entity_count1").unwrap(),
                        row.get("required_entity_count2").unwrap(),
                        row.get("required_entity_count3").unwrap(),
                        row.get("required_entity_count4").unwrap(),
                    ],
                    required_spell_casts: [
                        row.get("required_spell_cast1").unwrap(),
                        row.get("required_spell_cast2").unwrap(),
                        row.get("required_spell_cast3").unwrap(),
                        row.get("required_spell_cast4").unwrap(),
                    ],
                    reward_choice_item_ids: [
                        row.get("reward_choice_item_id1").unwrap(),
                        row.get("reward_choice_item_id2").unwrap(),
                        row.get("reward_choice_item_id3").unwrap(),
                        row.get("reward_choice_item_id4").unwrap(),
                        row.get("reward_choice_item_id5").unwrap(),
                        row.get("reward_choice_item_id6").unwrap(),
                    ],
                    reward_choice_item_counts: [
                        row.get("reward_choice_item_count1").unwrap(),
                        row.get("reward_choice_item_count2").unwrap(),
                        row.get("reward_choice_item_count3").unwrap(),
                        row.get("reward_choice_item_count4").unwrap(),
                        row.get("reward_choice_item_count5").unwrap(),
                        row.get("reward_choice_item_count6").unwrap(),
                    ],
                    reward_item_ids: [
                        row.get("reward_item_id1").unwrap(),
                        row.get("reward_item_id2").unwrap(),
                        row.get("reward_item_id3").unwrap(),
                        row.get("reward_item_id4").unwrap(),
                    ],
                    reward_item_counts: [
                        row.get("reward_item_count1").unwrap(),
                        row.get("reward_item_count2").unwrap(),
                        row.get("reward_item_count3").unwrap(),
                        row.get("reward_item_count4").unwrap(),
                    ],
                    reward_rep_factions: [
                        row.get("reward_rep_faction1").unwrap(),
                        row.get("reward_rep_faction2").unwrap(),
                        row.get("reward_rep_faction3").unwrap(),
                        row.get("reward_rep_faction4").unwrap(),
                        row.get("reward_rep_faction5").unwrap(),
                    ],
                    reward_rep_values: [
                        row.get("reward_rep_value1").unwrap(),
                        row.get("reward_rep_value2").unwrap(),
                        row.get("reward_rep_value3").unwrap(),
                        row.get("reward_rep_value4").unwrap(),
                        row.get("reward_rep_value5").unwrap(),
                    ],
